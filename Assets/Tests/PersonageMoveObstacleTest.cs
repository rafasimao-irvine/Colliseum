...
[IntegrationTest.DynamicTest("PersonageMoveObstacleTest")]
public class PersonageMoveObstacleTest : MonoBehaviour {
	...
	void Start () {
		...
		// Put objs in
		PutIn(TestObstacle, _MapTiles[2,6]);
	...
	void Update () {
		...
		if (_MadeAction && !TestPersonage.IsInAction()) {
			...
			case 0:
				...
				break;
			case 1:
				AssertChangeTileInfos(TestPersonage, _MapTiles[3,5], _MapTiles[4,4]);
				break;
			case 3:
